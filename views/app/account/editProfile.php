                    ...
                    <form action="editProfile.php" method="post">
                        <div class="input-field">
                            <div class="first-name">
                                ...
                                <input type="text" name="first-name" id="first-name-input" value="<?php echo $defaultFirstName; ?>">
                            </div>
                            <div class="last-name">
                                <label for="last-name-input">Last Name</label>
                                <input type="text" name="last-name" id="last-name-input" value="<?php echo $defaultLastName; ?>">
                            </div>
                        </div>
                        <div class="input-field">
                            <label for="username-input">Username</label>
                            <input type="text" name="username" id="username-input" value="<?php echo $defaultUsername?>">
                        </div>
                        <div class="input-field">
                            <label for="email-input">Email</label>
                            <input type="email" name="email" id="email-input" value="<?php echo $defaultEmail; ?>">
                        </div>
                        <div class="input-field">
                            <label for="dob-input">Date of Birth</label>
                            <input type="date" name="dob" id="dob-input" value="<?php echo $defaultDob; ?>">
                        </div>
                        <input type="submit">
                    </form>
                </div>
