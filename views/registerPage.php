        ...
        <div id="form-box">
            <form action="registerPage.php" method="post">
                ...
                <div class="input-field">
                    ...
                    <span class="validation-message"><?php if(!empty($nameError)) echo $nameError; $nameError = "";?></span>
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    <input type="date" placeholder="Date of Birth" name="dob" value="" min="1970-01-01" max="2018-01-01">
                    <span class="validation-message"><?php if(!empty($emailError)) echo $emailError; $emailError = "";?></span>
                </div>
                <div class="input-field">
